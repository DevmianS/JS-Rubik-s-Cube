...
var array1 = [topLeftFrontFront,topFrontFront]
...
//move pieces--------------------------------------------
       ...
       // piecesArr[2].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(0px) translateY(-100px) translateZ("+(translateZ+spacing)+"px)" ;
       ...
       // piecesArr[1].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(-100px) translateY(-100px) translateZ("+(translateZ+spacing)+"px)" ;       
  ...
  //WIP
        piecesArr[1].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(-100px) translateY(-100px) translateZ("+(translateZ+spacing)+"px)" ;       
        piecesArr[2].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(0px) translateY(-100px) translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[3].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(100px) translateY(-100px) translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[4].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(-100px) translateY(0px) translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[5].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(0px) translateY(0px) translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[6].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(100px) translateY(0px) translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[7].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(-100px) translateY(100px) translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[8].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(0px) translateY(100px) translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[9].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw)+"deg) translateX(100px) translateY(100px)translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[10].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw+90)+"deg) translateX(-100px) translateY(-100px)  translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[11].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw+90)+"deg) translateX(0px) translateY(-100px) translateZ("+(translateZ+spacing)+"px)" ;
        piecesArr[12].style.transform = "rotateX( "+pitch+"deg) rotateY("+(yaw+90)+"deg) translateX(100px) translateY(-100px) translateZ("+(translateZ+spacing)+"px)" ;
